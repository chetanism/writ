...
| | | |
|---|---|---|
| [`/canon:solo`](solo.md) | A new project, one person plus agents | The ten-phase interview |
| [`/canon:team`](team.md) | A new project, several people | The same, plus roles, handoffs, WIP limits and CODEOWNERS |
| [`/canon:adopt`](adopt.md) | A codebase that already exists | Survey it, document what the code cannot say about itself, enforce nothing on day one |
