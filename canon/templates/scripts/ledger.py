...
DEFAULTS = {
    ...
    # Everything the bootstrap fills in, not only what it fills in under `canon/`: the emitted
    ...
    "placeholder_scan": {
        "include": ["canon/**/*.md", "CLAUDE.md", "README.md", ".claude/skills/**/*.md", ".github/workflows/*.yml"],
