...
work. It is the **human-facing half** of the ledger, and `canon/process/COVERAGE.md` is the
mechanical half.
...
| Write manual test scenarios from it | Whoever tests by hand, with `/test-scenarios <id>`. They land in `canon/qa/scenarios/` and never here |
