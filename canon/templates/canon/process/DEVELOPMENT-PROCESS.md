...
`canon/qa/README.md` is the whole process; this section says why it exists and where it touches this
document.
...
So: one file per requirement under `canon/qa/scenarios/<area>/`, holding the scenarios themselves —
