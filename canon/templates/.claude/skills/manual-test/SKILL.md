...
3. **Report only.** Do not edit any file in the repository, do not commit, do not open an issue, do
   not add an entry to `canon/process/MANUAL-REGRESSION.md`. Findings go in the transcript under
...
`canon/process/MANUAL-REGRESSION.md` — and **do not write one**. Rule 3.
