...
Step 7 of the loop in `canon/process/DEVELOPMENT-PROCESS.md`. Invoked as `/slice-close`.
...
Under `canon/qa/scenarios/`, find every scenario whose *Not testable yet* row, or whose `Ready`
