...
The track described in `canon/qa/README.md`. **The detail file already settled what the requirement
...
identifier lowercased — `qa/fr-acc-01`. `canon/qa/README.md` says why; this is how.
...
| `canon/qa/scenarios/<area>/`, the neighbouring files | What a tester will already have run, so this file does not repeat it |
...
Copy `canon/process/templates/test-scenarios.md` to `canon/qa/scenarios/<area>/<id>.md` — the area is
