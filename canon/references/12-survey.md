...
`canon/spec/debt.md` — `DEBT-NNN`, one row each. A specification reverse-engineered from working
...
2. Areas confirmed and named. These become `canon/spec/requirements/<AREA>/index.md`, mostly empty.
