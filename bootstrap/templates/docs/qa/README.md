...
> **Precedence:** the requirement's detail file wins over everything here, and `docs/spec/BRD.md`
...
`docs/process/requirements/` says what a requirement **means** — the job somebody is doing, who must
...
```text
docs/qa/scenarios/<area>/<id>.md      FR-ACC/FR-ACC-01.md, INV/INV-1.md
```
