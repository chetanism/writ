...
The output is a `writ/` tree, a survey, a perimeter that enforces nothing yet, and the thirteen
project skills.
...
`SLICE-QUEUE.md`, `MANUAL-REGRESSION.md`, both `writ/process/templates/`, `writ/decisions/`,
