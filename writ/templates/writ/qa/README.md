...
`writ/spec/requirements/` says what a requirement **means** — the job somebody is doing, who must
...
```text
writ/qa/scenarios/<area>/<id>.md      FR-ACC/FR-ACC-01.md, INV/INV-003.md
```
