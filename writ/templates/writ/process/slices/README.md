...
**Filed at `<milestone>/<phase>/<slice id>.md`, mirroring the work order** — `m1-mvp/P01/SL-000.md`
for `work-orders/m1-mvp/P01/000.md`. `python3 scripts/ledger.py check` looks there and nowhere else,
