...
The other half of the track in `writ/spec/requirements/README.md`. A slice proves the claims it
...
Check `writ/process/COVERAGE.md` first:
...
1. **Read the scenario runs first**, where `writ/qa/scenarios/<area>/<id>.md` exists. A `pass`
