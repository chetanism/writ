...
```
writ/spec/               @brd-owner @requirements-author
writ/spec/requirements/  @detail-approver
writ/decisions/          @invariant-approver
writ/process/            @slicer
writ/qa/                 @test-manager
writ/maintenance/        @security-backlog-owner
scripts/                  @slicer
```
