...
opt-in escalation. That is a different default from `/writ:solo`, which assumes the repository is
...
The writ tree is outside the perimeter whatever the patterns say. Documents are how this process
...
**A five-person team with one writ user installs solo.** Team mode is about contention, and
