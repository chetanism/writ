...
So keep a record. **`.writ-interview.md` at the target root, appended after every phase**, and
...
If the target already has `<writ>/spec/` **and** an interview record, the earlier run got past
